...
import { ArrowLeft, Calendar, Clock, MapPin, Phone, Mail, Navigation, Play, Square, CheckCircle } from 'lucide-react'
              ...
              {client.address && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">{client.address}</p>
                  </div>
                </a>
              )}
            </div>
