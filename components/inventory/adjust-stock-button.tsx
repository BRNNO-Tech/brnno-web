...
export default function AdjustStockButton({ item }: { item: any }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={`e.g., 15 ${item.unit_of_measure}`}
              autoFocus
            />
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
              Current: {item.current_quantity.toFixed(2)} {item.unit_of_measure}
            </p>
          </div>
